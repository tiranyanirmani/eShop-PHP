                ...
                <div class="row">
                    ...
                    <div class="col-12 mb-4">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <h5>INVOICE TO : </h5>
                                <h2>Thinuka Ravindith</h2>
                                <span>Piliyandala</span><br>
                                <span>thinuka1@gmail..com</span>
                            </div>

                            <div class="col-6 text-end mt-4">
                                <h1 class="text-primary">INvOICE 01</h1>
                                <span class="fw-bold">Date & Time of Invoice : </span>&nbsp;
                                <span class="fw-bold">05/07/2022</span>
                            </div>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr style="height: 72px;">
                                    ...
                                    <td>
                                        <span class="fw-bold text-primary text-decoration-underline p-2">00001</span><br>
                                        <span class="fw-bold fs-3 text-primary  p-2">Apple iPhone 12</span>
                                    </td>
                                    <td class="fw-bold fs-6 text-end pt-3 bg-secondary text-white">Rs. 100000 .00</td>
                                    <td class="fw-bold fs-6 text-end pt-3">1</td>
                                    <td class="fw-bold fs-6 text-end pt-3 bg-primary text-white">Rs. 100000 .00</td>
                                </tr>
                            </tbody>
                            <tfoot>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end border-primary">Rs. 800 .00</td>
                                </tr>

                                <tr>
                                    <td colspan="3" class="border-0"></td>
                                    <td class="fs-5 text-end border-primary text-primary fw-bold">Grand Total</td>
                                    <td class="fs-5  text-end border-primary text-primary fw-bold">Rs. 100800 .00</td>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
